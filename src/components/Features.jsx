  ...
  return (
    <div
      ...
      <div>
        ...
        <p className="text-xs md:text-sm text-slate-500 text-center mt-2 max-w-md mx-auto px-2">
          BetterNotes keeps things simple — quick notes, clean design, and
          powerful features that help you capture thoughts in seconds. No
          clutter, no chaos, just focus.
        </p>
        ...
        <div className="flex items-center justify-center flex-wrap gap-6 mt-20 px-4 md:px-0">
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-violet-200 gap-6 max-w-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Open, type, and save — all in a heartbeat. BetterNotes is built
                for speed, so your ideas never have to wait.
              </p>
            </div>
          </div>
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                No distractions, no complex menus — just a clean space to think,
                write, and move on. Simple by design, powerful in practice.
              </p>
            </div>
          </div>
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Access your notes seamlessly from any device. BetterNotes makes
                sure your ideas follow you, wherever inspiration strikes.
              </p>
            </div>
          </div>
        </div>
